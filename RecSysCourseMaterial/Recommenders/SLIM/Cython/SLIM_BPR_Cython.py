...
from RecSysCourseMaterial.Recommenders.Recommender_utils import similarityMatrixTopK
from RecSysCourseMaterial.Recommenders.Incremental_Training_Early_Stopping import Incremental_Training_Early_Stopping


from RecSysCourseMaterial.CythonCompiler.run_compile_subprocess import run_compile_subprocess
import os, sys
...
class SLIM_BPR_Cython(BaseItemSimilarityMatrixRecommender, Incremental_Training_Early_Stopping):
    ...
    def fit(self, epochs=300,
        ...
        from RecSysCourseMaterial.Recommenders.SLIM.Cython.SLIM_BPR_Cython_Epoch import SLIM_BPR_Cython_Epoch
